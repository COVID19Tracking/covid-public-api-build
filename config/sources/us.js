...
module.exports = {
  ...
  fieldDefinitions: [
    ...
    },
    {
      ...
      type: 'integer',
      graphQlType: 'Int',
      description: 'Deprecated. Computed by adding *positive* and *negative* values to work around reporting lags between positives and total tests and because some states do not report totals.',
      nullable: true,
      example: 50,
    ...
    },
    {
      ...
      type: 'integer',
      graphQlType: 'Int',
      description: 'Deprecated. Increase in *death* computed by subtracting the value of *death* for the previous day from the value of *death* for the current day.',
      nullable: true,
      example: 50,
    ...
    },
    {
      ...
      type: 'integer',
      graphQlType: 'Int',
      description: 'Deprecated. Increase in *hospitalizedCumulative* computed by subtracting the value of *hospitalizedCumulative* for the previous day from the value of *hospitalizedCumulative* for the current day.',
      nullable: true,
      example: 50,
      sourceFunction: (item) => 0,
    },
    {
      ...
      type: 'integer',
      graphQlType: 'Int',
      description: 'Deprecated. Increase in *negative* computed by subtracting the value of *negative* for the previous day from the value for *negative* from the current day.',
      nullable: true,
      example: 50,
      sourceFunction: (item) => 0,
    },
    {
      ...
      type: 'integer',
      graphQlType: 'Int',
      description: 'Deprecated. Increase in *positive* computed by subtracting the value of *positive* from the previous day from the value of *positive* for the current day.',
      nullable: true,
      example: 50,
      sourceFunction: (item) => 0,
    },
